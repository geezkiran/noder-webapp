...
export const NavAccountCard = ({
    ...
    return (
        <div ref={triggerRef} className="relative flex items-center gap-3 rounded-xl p-3">
            ...
            <AriaDialogTrigger>
                <AriaButton className="absolute top-2 right-2 flex cursor-pointer items-center justify-center rounded-md p-1.5 text-fg-quaternary outline-focus-ring transition duration-100 ease-linear hover:bg-transparent hover:text-fg-quaternary_hover focus-visible:outline-2 focus-visible:outline-offset-2 pressed:bg-transparent pressed:text-fg-quaternary_hover">
